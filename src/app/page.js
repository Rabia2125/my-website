    ...
    <main className="bg-gray-950 text-white min-h-screen scroll-smooth">
      ...
      <section id="contact" className="py-20 px-10">
        ...
        <form className="max-w-lg mx-auto flex flex-col gap-4">
          <input type="text" placeholder="Full Name" className="p-3 bg-gray-900 border border-gray-800 rounded" required />
          <input type="email" placeholder="Email Address" className="p-3 bg-gray-900 border border-gray-800 rounded" required />
          <textarea placeholder="Your Message" className="p-3 bg-gray-900 border border-gray-800 rounded h-32" required></textarea>
          <button className="bg-blue-600 py-3 rounded font-bold hover:bg-blue-700 transition">Send Message</button>
        </form>
      </section>
